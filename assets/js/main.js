...
var _user$project$Model$initialFirstNode = {
	id: -1,
	text: 'Simple node text',
	buttons: {ctor: '[]'}
};
var _user$project$Model$initialBot = {
	id: -1,
	name: '-',
	description: '-',
	first_node: _user$project$Model$initialFirstNode,
	nodes: {ctor: '[]'}
};
var _user$project$Model$initialModel = {bot: _user$project$Model$initialBot, error: _elm_lang$core$Maybe$Nothing};
var _user$project$Model$Model = F2(
	function (a, b) {
		return {bot: a, error: b};
	});
var _user$project$Model$Bot = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, description: c, nodes: d, first_node: e};
	});
var _user$project$Model$Node = F3(
	function (a, b, c) {
		return {id: a, text: b, buttons: c};
	});
var _user$project$Model$Button = F3(
	function (a, b, c) {
		return {id: a, text: b, target_node: c};
	});
var _user$project$Model$TargetNode = function (a) {
	return {ctor: 'TargetNode', _0: a};
};
...
var _user$project$Node_View$nodeView = function (model) {
	var node_name = model.text;
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(node_name),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Commands$fetch = function () {
	var apiUrl = '/api/bot/1';
	var request = A2(_elm_lang$http$Http$get, apiUrl, _user$project$Decoders$botDecoder);
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Bot_View$botView(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$init = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Commands$fetch,
		_1: {ctor: '[]'}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"FetchResult":["Result.Result Http.Error Model.Bot"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Model.TargetNode":{"args":[],"tags":{"TargetNode":["Model.Node"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Model.Button":{"args":[],"type":"{ id : Int, text : String, target_node : Model.TargetNode }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Model.Bot":{"args":[],"type":"{ id : Int , name : String , description : String , nodes : List Model.Node , first_node : Model.Node }"},"Model.Node":{"args":[],"type":"{ id : Int, text : String, buttons : List Model.Button }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
