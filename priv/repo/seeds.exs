...
nodes_easy_invest = [
  ...
  %Node{text: "As restrições em qualquer órgão de avaliação de crédito (Serasa e SPC) não são impeditivos para abrir uma conta para investimentos. Assista os vídeos abaixo e abra sua conta na Easynvest!!", bot_id: bot_easy_invest.id},
